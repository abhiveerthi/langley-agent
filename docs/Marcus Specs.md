...
A single-page landing with waitlist capture lives at [apps/web](http://apps/web/). Visitors drop an email \+ channel URL and get a **free AI content strategy report** for their channel when we launch — generated live by the Strategist on sign-up.
...
See [ROADMAP.md](http://ROADMAP.md) for the detailed build plan.
