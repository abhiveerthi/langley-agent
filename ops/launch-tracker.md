...
| 2 | **Google OAuth app** — new client in YOUR project, publish it | You | 🟡 ALMOST | New OAuth client created in your "Langley YouTube RAG" project (Sept 3) and wired into the platform — the old client turned out to live in the former partner's Google account. **To confirm and close:** (a) Data Access has the three YouTube scopes, (b) Audience → Publish app, (c) YouTube Data API v3 enabled in the Library. |
