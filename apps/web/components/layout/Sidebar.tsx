...
const studioItems = [
  { label: "Auto Clips", href: "/studio/clips", icon: Scissors },
  { label: "Dubbing", href: "/studio/dubbing", icon: Languages },
  { label: "Subtitles", href: "/studio/subtitles", icon: Subtitles },
  { label: "Thumbnails", href: "/studio/thumbnails", icon: Image },
  { label: "Script Writer", href: "/studio/scripts", icon: FileText },
  { label: "SEO Optimizer", href: "/studio/seo", icon: Search },
];

const agentItems = [
  { label: "All Agents", href: "/agents", icon: Bot, exact: true },
  { label: "Trend Scout", href: "/agents/research", icon: Radar },
  { label: "Content Strategist", href: "/agents/intel", icon: Lightbulb },
  { label: "Growth Engine", href: "/agents/comms", icon: Rocket },
];

const analyzeItems = [
  { label: "Dashboard", href: "/dashboard", icon: BarChart3 },
  { label: "Comments", href: "/analytics/comments", icon: MessageCircle },
  { label: "Trends", href: "/analytics/trends", icon: TrendingUp },
];

const businessItems = [
  { label: "Brand Deals", href: "/crm", icon: Briefcase },
...
function BotConnectionsItem() {
  const pathname = usePathname();
  const isActive = pathname.startsWith("/agents/bots");
  return (
    <Link
      href="/agents/bots"
      className={cn(
