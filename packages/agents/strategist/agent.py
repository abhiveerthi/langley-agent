...
from packages.agents.strategist.prompts import STRATEGIST_SYSTEM_PROMPT
...
class StrategistAgent(BaseAgent):
    slug = "strategist"
    name = "Strategist"
    description = "Decides what to make next. Pulls channel analytics and niche trends, ranks video ideas, drafts scripts and hooks."
